export default function CardView() {
  return (
    <main className="m-0 flex h-screen items-center justify-center bg-[#f4d04e]">
      <div className="min-h-[501px] w-[327px] rounded-[20px] border-[1px] border-[#111111] bg-white p-[24px] shadow-[8px_8px_0px_0px_black] overflow-hidden lg:min-h-0 lg:w-[384px]">
        <div>
          <img
            className="w-full"
        ...
        <div className="mt-[24px] mb-[24px] lg:text-[14px] flex flex-col gap-3">
