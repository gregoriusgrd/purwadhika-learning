export default function CardView() {
  return (
    <main className="m-0 flex h-screen items-center justify-center bg-[#f4d04e]">
      <div className="min-h-[501px] w-[327px] overflow-hidden rounded-[20px] border-[1px] border-[#111111] bg-white p-[24px] shadow-[8px_8px_0px_0px_black] lg:min-h-0 lg:w-[384px]">
        <div>
        ...
        <div className="mt-[24px] flex flex-col gap-3 lg:text-[14px]">
          ...
          <div className="font-figtree text-[14px] leading-[150%] font-medium tracking-[0%] text-[#6b6b6b] lg:text-[16px]">
