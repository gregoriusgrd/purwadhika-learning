export default function PerfumeView() {
  return (
    <main className="m-0 flex h-screen items-center justify-center bg-[#f2eae2]">
      <div className="w-[343px] overflow-hidden rounded-[10px] bg-white">
        <div>
          <img
        ...
        <div className="p-6">
          ...
          <div className="font-fraunces mt-3 text-[32px] leading-8 font-bold tracking-normal text-[#1C232B]">
            Gabrielle Essence Eau De Parfum
          </div>
          <div className="font-monserrat mt-4 text-[14px] leading-6 font-medium tracking-normal text-[#6c7289]">
          ...
          <button className="mt-5 flex h-[48px] w-full items-center justify-center gap-3 rounded-[8px] bg-[#3d8168]">
